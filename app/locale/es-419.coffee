module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  ...
  new_home:
    ...
    top_screenshots_hint: "Los estudiantes escriben código y ven sus cambios actualizados en tiempo real"
    ...
    request_demo_title: "Invita a tus estudiantes a comenzar hoy"
    request_demo_subtitle: "Solicita un demo e invita a tus estudiantes a iniciar en menos de una hora."
    get_started_title: "Configura tu clase hoy"
    get_started_subtitle: "Configura una clase, agrega tus estudiantes y supervisa su progreso de como aprenden la ciencia de la computacion."
    ...
    class_in_box: "Aprender cómo nuestra plataforma de aula-en-una-caja encaja en su plan de estudios."
    get_started: "Empezar"
...
#    toggle_nav: "Toggle navigation"
    jobs: "Trabajos"
    schools: "Escuelas"
    educator_wiki: "Wiki del maestro"
...
#  code:
    if: "Condicional 'Si'" # Keywords--these translations show up on hover, so please translate them all, even if it's kind of long. (In the code editor, they will still be in English.)
    else: "Si no"
    elif: "Si no, si"
    while: "mientras que"
    loop: "bucle o ciclo"
...
#    self: "self"
  ...
  signup:
    ...
    connected_gplus_p: "Finaliza el registro para que puedas iniciar sesión con tu cuenta de Google+."
    gplus_exists: "Ya tienes una cuenta asociada con Google+!"
    connected_facebook_header: "Te haz conectado exitosamente a travez de Facebook!"
    connected_facebook_p: "Finaliza el registro para que puedas iniciar sesión con tu cuenta de Facebook."
    facebook_exists: "Ya tienes una cuenta asociada con Facebook!"
...
#    tip_mulan: "Believe you can, then you will. - Mulan"
  ...
  choose_hero:
    ...
    java_blurb: "(Solo suscriptor) Android y empresa."
    status: "Estado"
    hero_type: "Tipo"
    weapons: "Armas"
...
#    no_purchaser_role: "No role in purchase decisions"
    ...
    thanks_sub_header: "Gracias por expresar interés en CodeCombat para su escuela."
...
#    teacher_account_restricted: "Your account is a teacher account, and so cannot access student content."
  ...
  teacher:
    ...
    language: "Lenguaje"
    edit_class_settings: "Editar configuraciones de clases"
    complete: "Completado"
    access_restricted: "Se requiere cuenta actualizada"
    teacher_account_required: "Se requiere una cuenta de maestro para accesar a este contenido."
    create_teacher_account: "Crear una cuenta de Maestro"
    what_is_a_teacher_account: "¿Que es una cuenta de maestro?"
...
#    forbidden_desc: "Oh no, there’s nothing we can show you here! Make sure you’re logged into the correct account, or visit one of the links below to get back to programming!"
    ...
    not_found_desc: "Hm, no hay nada aqui. visita uno de los siguiente enlaces para volver a la programacion!"
